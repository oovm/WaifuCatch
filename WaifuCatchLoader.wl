...
(* ::Text::GrayLevel[0.5]:: *)
(* Autogenerated WaifuCatch loader file *)


Temp`PackageScope`WaifuCatchLoading`Private`$DependencyLoad=
  TrueQ@Temp`PackageScope`WaifuCatchLoading`Private`$DependencyLoad;
If[Temp`PackageScope`WaifuCatchLoading`Private`$DependencyLoad,
  Unprotect["`WaifuCatch`PackageScope`Private`Constants`$TopLevelLoad"];
  Evaluate[Symbol["`WaifuCatch`PackageScope`Private`Constants`$TopLevelLoad"]]=False,
  Unprotect["WaifuCatch`PackageScope`Private`Constants`$TopLevelLoad"];
  Evaluate[Symbol["WaifuCatch`PackageScope`Private`Constants`$TopLevelLoad"]]=
    MemberQ[$ContextPath, "Global`"]
  ];


If[Temp`PackageScope`WaifuCatchLoading`Private`$DependencyLoad,
  Evaluate[Symbol["`WaifuCatch`PackageScope`Private`$RootContext"]]=$Context;
  BeginPackage["`WaifuCatch`"],
  Evaluate[Symbol["WaifuCatch`PackageScope`Private`$RootContext"]]="";
  BeginPackage["WaifuCatch`"]
  ]


ClearAll[WaifuCatch];
WaifuCatch::usage="WaifuCatch is a manager head for the WaifuCatch package";
...
WaifuCatch["LoadingParameters"]:=$PackageLoadSpecs
$PackageLoadSpecs=
  Merge[
    {
      With[
...
WaifuCatch["Mode"]:=$PackageLoadingMode
$PackageLoadingMode=
...
WaifuCatch["Dependencies"]:=$PackageDependencies;
$PackageDependencies=
...
WaifuCatch["DependencyBase"]:=$PackageDependencyBase;
...
WaifuCatch["PackageListing"]:=$PackageListing;
$PackageListing=<||>;
WaifuCatch["Contexts"]:=$PackageContexts;
  ...
  $PackageContexts=
    Join[
      If[$PackageLoadingMode==="Dependency",
        ...
        {
          "WaifuCatch`",
          "WaifuCatch`PackageScope`Private`",
          "WaifuCatch`PackageScope`Package`"
          },
...
WaifuCatch["FEScopedSymbols"]:=$PackageFEHiddenSymbols;
$PackageFEHiddenSymbols={};
WaifuCatch["PackageScopedSymbols"]:=$PackageScopedSymbols;
...
WaifuCatch["FileContexts"]:=$PackageFileContexts;
...
WaifuCatch["DeclaredPackages"]:=$DeclaredPackages;
...
WaifuCatch["LoadedPackages"]:=$LoadedPackages;
...
PackageFileContext[f_String?DirectoryQ]:=
  With[{s=PackageFileContextPath[f]},
    StringRiffle[Append[""]@Prepend[s,WaifuCatch],"`"]
    ];
...
WaifuCatch::nodep="Couldn't load dependency `` of type ``";
WaifuCatch::nodup="Couldn't update dependency `` of type ``";
  ...
  Block[{retcode, site, path, file, tmp},
    ...
    site=
      ...
      If[retcode<300,
        ...
        DeleteFile[tmp];
        file,
        Message[WaifuCatch::nodep, dep, "Package"];
        DeleteFile[tmp];
        $Failed
        ]
      ];
    ...
    Monitor[
      MapThread[
        Check[
          ...
          Message[WaifuCatch::nodep, #2, "Paclet"];
          $Failed
          ]&,
        {
          pacs,
      ...
      Monitor[
        MapThread[
          Check[
            ...
            Message[WaifuCatch::nodup, #2, "Paclet"];
            $Failed
            ]&,
          {
            StringDelete[deps, "`"],
...
$PackageErrorMessage=
  "WaifuCatch encountered exception ``";
...
PackageCatchMessage[
  ...
  Replace[
    Thread[Map[Hold[MessageName[WaifuCatch, #]]&, msg], Hold],
    {
      {}:>
        Check[expr, 
...
PackageFailureException[
  ...
  (
    Set[MessageName[WaifuCatch, tag], body];
    PackageFailureException[
      MessageName[WaifuCatch, tag],
      body,
      ops
...
PackageAttachMainAutocomplete[]:=
  PackageAddAutocompletions[WaifuCatch, 
    Table[
      Replace[{}->None]@
        Cases[
          DownValues[WaifuCatch],
          Nest[
            Insert[#, _, {1, 1, 1}]&,
            (HoldPattern[Verbatim[HoldPattern]][
              WaifuCatch[s_String, ___]
              ]:>_),
            n-1
            ]:>s,
          Infinity
...
PackagePrepPackageSymbol[]:=
  Switch[$AllowPackageSymbolDefinitions,
    None,
      If[Length@OwnValues[WaifuCatch]==0,
        Remove[WaifuCatch],
        DownValues[WaifuCatch]={}
        ],
    False,
...
If[Temp`PackageScope`WaifuCatchLoading`Private`$DependencyLoad,
  If[
    (Clear@`WaifuCatch`PackageScope`Private`$loadAbort;!#)&@
      `WaifuCatch`PackageScope`Private`$loadAbort,
    Unprotect[`WaifuCatch`PackageScope`Private`$LoadCompleted];
    `WaifuCatch`PackageScope`Private`$LoadCompleted=True;
    `WaifuCatch`PackageScope`Private`PackagePostProcessContextPathReassign[]
    ],
  If[
    (Clear@WaifuCatch`PackageScope`Private`$loadAbort;!#)&@
      WaifuCatch`PackageScope`Private`$loadAbort,
...
Remove["Temp`PackageScope`WaifuCatchLoading`Private`*"]